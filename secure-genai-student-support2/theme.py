...
:root{
  --bg:#0c1424; --bg-2:#101a2e; --panel:#172339; --panel-2:#13203a;
  --line:rgba(140,178,224,.22); --line-2:rgba(140,178,224,.34);
  --ink:#f4f8ff; --muted:#b6c6df; --faint:#7e93b8;
  --cyan:#43e8da; --sky:#4cb4ff; --amber:#ffc34d; --rose:#ff8b9a;
  --green:#54e89a; --violet:#ad9cff;
}
...
.stApp{
  background:
    radial-gradient(1100px 600px at 8% -10%, rgba(76,180,255,.16), transparent 55%),
    radial-gradient(1000px 560px at 100% -6%, rgba(67,232,218,.13), transparent 52%),
    radial-gradient(800px 800px at 50% 125%, rgba(173,156,255,.08), transparent 60%),
    linear-gradient(180deg,#0c1424 0%, #0f1a2e 100%);
  color:var(--ink);
}
.stApp::before{
