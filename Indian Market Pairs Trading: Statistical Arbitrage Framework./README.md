...
1. Project Overview
This project develops a robust framework for Pairs Trading (a market-neutral investment strategy) specifically tailored for the National Stock Exchange (NSE). It systematically identifies cointegrated stock pairs using clustering techniques and simulates strategy performance through a custom backtesting engine and an interactive dashboard.

2. Universe & Data Scope
The strategy is applied to a universe of 90+ high-liquidity Indian tickers organized into 10 key sectors:
...
Phase I: Feature Engineering & Fundamental Analysis
Data Ingestion: Real-time and historical data fetching via yfinance.
...
Phase II: Unsupervised Learning (Clustering)
To minimize the search space for pairs and ensure business similarity, we utilize:
...
Stationarity Testing: Augmented Dickey-Fuller (ADF) test to ensure mean-reverting properties.
...
Phase IV: Strategy Backtesting & Visualization
Risk Metrics: Calculation of Total Net Return, Max Drawdown, and Sharpe Ratio.
